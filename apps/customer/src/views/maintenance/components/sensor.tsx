  ...
  return (
    ...
    >
      ...
      <div className='relative z-10 text-white h-full flex flex-col'>
        <h2 className='text-2xl font-bold mb-1'>传感器系统</h2>
        <motion.div
        ...
        <div className='flex flex-1 flex-col gap-2 py-2 overflow-y-auto'>
          ...
          <div className='grid grid-cols-3 gap-4 items-center'>
            ...
            <ProgressBar className='col-span-2' min={0} max={6} value={5} height={12} />
          </div>
          <div className='grid grid-cols-3 gap-4 items-center'>
            <Typography.Title level={5} className='flex-1 text-nowrap !m-0'>
              牙尖传感器（月）
            </Typography.Title>
            <ProgressBar className='col-span-2' min={0} max={10} value={2} height={12} />
          </div>
        </div>
      </div>
    </motion.div>
