      ...
      <div className="flex-1 m-[12px]">
        ...
        >
          <div className="w-full h-full relative">
            ...
            <span className="absolute bottom-[-20px] right-[26%]">
              {t("左右补偿")}
            </span>
          </div>
        </ImagesWidthTips>
  ...
  return (
    <div className="flex-1 m-[12px]">
      <Tips>
        ...
        4、
        {t(
          "装车之前需要如实填写货物宽度以及它装车的间隙,假设有多种托盘,则按照最大货物尺寸来填写。"
        )}
      </Tips>
      <ImagesWidthTips
        containClass="my-[30px]"
      ...
      >
        <div className="w-full h-full relative">
          ...
          <span className="absolute top-[27px] right-[26%]">
            {t("货物左右间隙")}
          </span>
        </div>
      </ImagesWidthTips>
      ...
      >
        <div className="w-full h-full relative">
          ...
          <span className="absolute top-[120%] right-[20%]">
            {t("路径规划")}
          </span>
        </div>
      </ImagesWidthTips>
      <div className="w-full text-center mt-[270px] pl-[80px]">
        {t("第一次视觉点")}
      </div>
      <ImagesWidthTips
        containClass="my-[10px]"
        ...
        tipsProps={multiTipsProps}
      ></ImagesWidthTips>
      <div className="w-full text-center mt-[80px] pl-[140px]">
        {t("第二次视觉点")}
      </div>
    </div>
  );
