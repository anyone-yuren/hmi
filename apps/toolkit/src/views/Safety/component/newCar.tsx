...
import CarHeader from './newCarComponents/carHeader';

const NewCar = (props: any) => {
    ...
    <>
      ...
      >
        <Group name='car'>
          ...
          <CarHeader
            width={width}
            topleft={{ x: meterToPixel(x4), y: meterToPixel(y4) }}
            topRight={{ x: meterToPixel(x3), y: meterToPixel(y3) }}
          />
        </Group>
