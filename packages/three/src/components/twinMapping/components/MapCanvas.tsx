...
const MapVisualization = ({ mappingData }) => {
  ...
  return (
    ...
    >
      ...
      {/* 阴影效果 */}
      {/* <ContactShadows position={[0, -4.5, 0]} opacity={0.4} scale={80} blur={6} far={30} resolution={2048} /> */}
      {/* <ContactShadows position={[0, -4.5, 0]} opacity={0.5} scale={50} blur={3} far={10} resolution={1024} /> */}
      {/* 设置背景色和环境光 */}
