...
import { BoxGeometry, MeshStandardMaterial, ShadowMaterial } from 'three';
...
const BoundaryFloor = (props: {
  ...
  const { mapMinX, mapMaxX, mapMinY, mapMaxY, referencePoints = [], floorOpacity = 0.8, mapVertices = [] } = props;
