  ...
  (set, get) => ({
    ...
    updateVehicles: (vehicles) => {
      ...
      if (vehicles?.length === 0) {
        useRcsGlobalStore.getState().setVehicleList([]);
      }
      ...
      useRcsGlobalStore.getState().setVehicleList(vehicles);
      set({ vehicles });
    },
    ...
    setWssLocationStateHashMap: (wssLocationStateHashMap) => {
      ...
      // debugger;
      useRcsGlobalStore.getState().setHasGoodLocations(wssLocationStateHashMap);
    },
