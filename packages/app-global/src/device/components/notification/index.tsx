...
import { SignalRProvider } from '../../../notification/components/signalRProvider';
import NotificationList from '../../../notification/module/notifitionList';
...
const Notification = () => {
  ...
  return (
    <>
      <Toaster richColors closeButton offset={16} />
      <SignalRProvider />
