...
export default function DrawBSpline() {
  ...
  const finishDrawing = () => {
    ...
    const sampledPoints = curve.getPoints(CURVE_SEGMENTS);
  ...
  }, [points, selectDrawType, lineList]); // Added lineList dependency for finishDrawing
