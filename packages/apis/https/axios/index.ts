...
import { StorageEnum } from '@gbeata/utils/types/enum';
...
const transform: AxiosTransform = {
  ...
  requestInterceptors: (config, options) => {
    // const token = 'eyJhbGciOiJSUzI1NiIsImtpZCI6IkVCMDYxMUJCOEE1MUE2MUY4QTM2QjkxNTQxNTA4Q0JBMDdDNUE3RjQiLCJ4NXQiOiI2d1lSdTRwUnBoLUtOcmtWUVZDTXVnZkZwX1EiLCJ0eXAiOiJhdCtqd3QifQ..JEYbFwSObXtMxtEnn2-A3ggltQ70AzBg3B3ih7TR20lqtml1hrsvcNipAVOgkY2WqNHPVMrfuwVZmdjGC6OgRrlwaPCcuAn7eIreO1Nl0gqIk-4S1g7afnxTDM_utbGHBOlDjMBFrCWGlCQmY0NIJEPJaRdnnAwC9LhCt_IdYWgk4QsdEDKy0ncnJY2FYWnFMvqzt5Xmufv8-fF7ESMyq1S00wHwUloi27fwQDDVfngJcbNnvWHIe0gqSxjEpj-HXpzmfSIzHin_s-_eku7IEep_WCoVSJUhHGgqZwtcnPwmvfxE6LLC_RgmtnZsUHwZSZ_ndcb76_7xWVQqDAk-Ig';
